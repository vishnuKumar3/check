...
.box{margin-top:10%;width:402px;border-radius:10px;padding-bottom:20px;border:1px solid black;}
...
.navbar{display:flex;flex-direction:row;justify-content:center;align-items:start;}
